...
import type { CarouselApi } from '@/shared/components/ui-kit/carousel'
import {
	Carousel,
	CarouselContent,
	CarouselItem,
...
export const Gallery = ({
	title = 'Наші роботи',
	description = 'Ми створюємо ефективну наружну рекламу: банери, вивіски, білборди, брендинг. Повний цикл від дизайну до монтажу. Збільшуємо вашу впізнаваність та залучаємо нових клієнтів.',
	items = data,
}: GalleryProps) => {
	...
	return (
		<section className='py-32 bg-mint'>
